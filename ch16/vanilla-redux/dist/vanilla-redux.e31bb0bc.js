...
var DECREASE = "DECREASE"; // 액션 객체를 만드는 액션 생성 함수
...
var store = (0, _redux.createStore)(reducer); // 상태가 업데이트 될 때마다 호출되는 render 함수 작성
...
render(); // 스토어의 상태가 바뀔 때마다 render 함수가 호출되도록 구독하기
